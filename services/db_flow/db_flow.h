 ...
 * @return K_SPP_ERROR_NULL_POINTER if @p p_pkt is NULL.
 * @return K_SPP_ERROR if the FIFO is full.
 */
 ...
 *
 * @return K_SPP_OK on success.
 * @return K_SPP_ERROR_NULL_POINTER if @p pp_pkt is NULL.
 * @return K_SPP_NOT_ENOUGH_PACKETS if the FIFO is empty.
 */
