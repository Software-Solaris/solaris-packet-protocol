 ...
 */
void SPP_EXTERNAL_ENCRYPTION_cipher( const uint8_t* key, const char mode, const block_t x, block_t y )
{
    KeyExpansion( key );
 ...
 */
void SPP_EXTERNAL_ENCRYPTION_ecbEncrypt( const uint8_t* key,
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_ecbDecrypt( const uint8_t* key,
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_cbcEncrypt( const uint8_t* key, const block_t iVec,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_cbcDecrypt( const uint8_t* key, const block_t iVec,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
 ...
 * @param   crtxt     resulting cipher-text buffer
 */
void SPP_EXTERNAL_ENCRYPTION_cfbEncrypt( const uint8_t* key, const block_t iVec,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
 ...
 * @param   pntxt     resulting plaintext buffer
 */
void SPP_EXTERNAL_ENCRYPTION_cfbDecrypt( const uint8_t* key, const block_t iVec,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
 ...
 * @param   crtxt     resulting cipher-text buffer
 */
void SPP_EXTERNAL_ENCRYPTION_ofbEncrypt( const uint8_t* key, const block_t iVec,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
    count_t n = ptextLen / BLOCKSIZE;
    uint8_t* y;
 ...
 * @param   pntxt     resulting plaintext buffer
 */
void SPP_EXTERNAL_ENCRYPTION_ofbDecrypt( const uint8_t* key, const block_t iVec,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    SPP_EXTERNAL_ENCRYPTION_ofbEncrypt( key, iVec, crtxt, crtxtLen, pntxt );
}
#endif /* OFB */
 ...
 * @param   crtxt     resulting cipher-text buffer
 */
void SPP_EXTERNAL_ENCRYPTION_ctrEncrypt( const uint8_t* key, const uint8_t* iv,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
#if PRESET_COUNTER
 ...
 * @param   pntxt     resulting plaintext buffer
 */
void SPP_EXTERNAL_ENCRYPTION_ctrDecrypt( const uint8_t* key, const uint8_t* iv,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    SPP_EXTERNAL_ENCRYPTION_ctrEncrypt( key, iv, crtxt, crtxtLen, pntxt );
}
#endif /* CTR */
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_xtsEncrypt( const uint8_t* keys, const uint8_t* tweak,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
    memcpy( crtxt, pntxt, ptextLen );            /*  do in-place encryption   */
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_xtsDecrypt( const uint8_t* keys, const uint8_t* tweak,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
 ...
 */
void SPP_EXTERNAL_ENCRYPTION_cmac( const uint8_t* key,
               const void* data, const size_t dataSize, block_t mac )
{
    block_t K1 = { 0 }, K2;
 ...
 */
void SPP_EXTERNAL_ENCRYPTION_gcmEncrypt( const uint8_t* key, const uint8_t* nonce,
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_gcmDecrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
 ...
 * @param   crtxt     resulting cipher-text buffer + message authentication tag
 */
void SPP_EXTERNAL_ENCRYPTION_ccmEncrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
    char* tag  = (char*) crtxt + ptextLen;
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_ccmDecrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    const char* tag = (char*) crtxt + crtxtLen;
 ...
 * @param   crtxt     resulting cipher-text buffer
 */
void SPP_EXTERNAL_ENCRYPTION_sivEncrypt( const uint8_t* keys,
                      const void* aData, const size_t aDataLen,
 ...
 * @return            whether message decryption/authentication was successful
 */
char SPP_EXTERNAL_ENCRYPTION_sivDecrypt( const uint8_t* keys, const block_t iv,
                      const void* aData, const size_t aDataLen,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    block_t IV;
 ...
 * @param   crtxt     resulting cipher-text buffer + message authentication tag
 */
void SPP_EXTERNAL_ENCRYPTION_gcmSivEncrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
    block_t P = { 0 };
 ...
 * @return            whether message decryption/authentication was successful
 */
char SPP_EXTERNAL_ENCRYPTION_gcmSivDecrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    block_t H, P = { 0 };
 ...
 */
void SPP_EXTERNAL_ENCRYPTION_eaxEncrypt( const uint8_t* key, const uint8_t* nonce,
#if EAXP
 ...
 * @return            whether message authentication/decryption was successful
 */
char SPP_EXTERNAL_ENCRYPTION_eaxDecrypt( const uint8_t* key, const uint8_t* nonce,
#if EAXP
                      const size_t nonceLen,
#else
                      const void* aData, const size_t aDataLen,
 ...
 * @param   crtxt     resulting cipher-text buffer + message authentication tag
 */
void SPP_EXTERNAL_ENCRYPTION_ocbEncrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
    block_t mac = { 0 };
 ...
 * @return            whether message decryption/authentication was successful
 */
char SPP_EXTERNAL_ENCRYPTION_ocbDecrypt( const uint8_t* key, const uint8_t* nonce,
                      const void* aData, const size_t aDataLen,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
    block_t mac = { 0 };
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_keyWrap( const uint8_t* kek,
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_keyUnwrap( const uint8_t* kek,
 ...
 */
void SPP_EXTERNAL_ENCRYPTION_poly1305( const uint8_t* keys, const block_t nonce,
                   const void* data, const size_t dataSize, block_t mac )
{
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_fpeEncrypt( const uint8_t* key, const TWEAK_PARAMS,
                      const void* pntxt, const size_t ptextLen, void* crtxt )
{
 ...
 */
char SPP_EXTERNAL_ENCRYPTION_fpeDecrypt( const uint8_t* key, const TWEAK_PARAMS,
                      const void* crtxt, const size_t crtxtLen, void* pntxt )
{
