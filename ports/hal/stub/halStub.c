...
static SPP_RetVal_t SPP_PORTS_HAL_STUB_spiBusInit(void)
{
    return K_SPP_OK;
}
static void *SPP_PORTS_HAL_STUB_spiGetHandle(spp_uint8_t deviceIdx)
{
    (void)deviceIdx;
    return (void *)0x1;
}
static SPP_RetVal_t SPP_PORTS_HAL_STUB_spiDeviceInit(void *p_handle)
{
    (void)p_handle;
    return K_SPP_OK;
}
static SPP_RetVal_t SPP_PORTS_HAL_STUB_spiTransmit(void *p_handle, spp_uint8_t *p_data,
                                                   spp_uint8_t len)
{
    (void)p_handle;
    (void)p_data;
...
static SPP_RetVal_t SPP_PORTS_HAL_STUB_gpioConfigInterrupt(spp_uint32_t pin, spp_uint32_t t,
                                                           spp_uint32_t pull)
{
    (void)pin;
    (void)t;
...
static SPP_RetVal_t SPP_PORTS_HAL_STUB_gpioRegisterIsr(spp_uint32_t pin, void *p_ctx)
{
    (void)pin;
    (void)p_ctx;
    return K_SPP_OK;
}
static SPP_RetVal_t SPP_PORTS_HAL_STUB_storageMount(void *p_cfg)
{
    (void)p_cfg;
    return K_SPP_OK;
}
static SPP_RetVal_t SPP_PORTS_HAL_STUB_storageUnmount(void *p_cfg)
{
    (void)p_cfg;
    return K_SPP_OK;
}
...
static void SPP_PORTS_HAL_STUB_delayMs(spp_uint32_t ms)
{
    (void)ms;
}
