 ...
 * @return retval_t SPP_OK on success, error code otherwise
 */
    retval_t OSAL_QueueCreate(osal_queue_handle_t *queue_handle, uint32_t queue_length,
                              uint32_t item_size);
 ...
 * @return retval_t SPP_OK on success, error code otherwise
 */
    retval_t OSAL_QueueSend(osal_queue_handle_t queue_handle, const void *item,
                            uint32_t timeout_ms);
