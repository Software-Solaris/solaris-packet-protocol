...
__attribute__((weak)) retval_t OSAL_TaskDelay(uint32_t delay_ms)
{
    ...
    volatile uint32_t counter = delay_ms * 1000;
    while (counter--)
    {
        /* Busy wait */
    }
 ...
 */
__attribute__((weak)) retval_t OSAL_QueueCreate(osal_queue_handle_t *queue_handle,
                                                uint32_t queue_length, uint32_t item_size)
{
 ...
 */
__attribute__((weak)) retval_t OSAL_SemaphoreCreate(osal_semaphore_handle_t *semaphore_handle,
 ...
 */
__attribute__((weak)) retval_t OSAL_SemaphoreTake(osal_semaphore_handle_t semaphore_handle,
                                                  uint32_t timeout_ms)
{
    if (semaphore_handle == NULL)
    {
